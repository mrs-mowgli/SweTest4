...
public class LoginMethods extends TestCode {
    ...
    String xpathSignInButtonFromStartPage = "//*[@id=\"_desktop_user_info\"]/div/a/span";
    ...
    protected void SignInButtonFromStartPage_Click()
    {
        findElementsByxPath("//*[@id=\"_desktop_user_info\"]/div/a/span","click","");
    }
    protected void ClickResetPasswordButton()
    {
        findElementsByxPath("//*[@id=\"content\"]/form/section/div/button[1]","click","");
    }
    protected void FillInEmailAddressInForgottenPasswordField(String email)
    {
        findElementsById("email","sendKeys",email);
    }
    protected void ForgottenPasswordClick()
    {
        findElementsByxPath("//*[@id=\"login-form\"]/section/div[3]/a","click","");
    }
    ...
    protected String GetSuccessMessage_ResettingPassword()
    {

        String expectedString = driver.findElement(By.id("content")).getText();
    ...
    protected String GetFailureMessage_ResettingPassword()
    {
        String expectedString = driver.findElement(By.id("content")).getText();
